    ...
    return (
        <div id="codeofconduct">
            <div className="container">
                <h1 className="section-heading">TreeHacks Code Of Conduct</h1>
