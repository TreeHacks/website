  ...
  render() {
    ...
    return (
      <div id="home">
        ...
        <h2>February 14-16, 2020 at&nbsp;Stanford&nbsp;University</h2>
        ...
        {hasEnded ? (
          ...
          <div>
            <a href="https://live.treehacks.com" className="green-button">
              view live schedule
            </a>
            <a
              href="https://root.treehacks.com"
              className="green-button subtle"
            >
              go to dashboard
            </a>
          </div>
          ...
          <div>
            <a href="https://root.treehacks.com" className="green-button">
              Stanford students register&nbsp;now!
            </a>
            <DeadlinesWidget />
          </div>
        )}
