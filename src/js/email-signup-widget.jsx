  ...
  return (
    <div className="emailSignup">
      <div id="mc_embed_signup">
        <form action="https://treehacks.us8.list-manage.com/subscribe/post?u=e6ff5c7ae36357707280fa752&amp;id=c672ebe87f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate>
